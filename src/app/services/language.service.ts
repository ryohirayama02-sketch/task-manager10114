...
export class LanguageService {
  ...
  > = {
    ...
    'login.confirmPasswordPlaceholder': { ja: 'パスワード（確認）', en: 'Confirm Password' },
    'login.noAccount': { ja: 'アカウントをお持ちでないですか？', en: "Don't have an account?" },
    'login.haveAccount': { ja: '既にアカウントをお持ちですか？', en: 'Already have an account?' },
    ...
    'gantt.projectSelector.title': { ja: '表示するプロジェクトを選択', en: 'Select Projects to Display' },
    'gantt.projectSelector.selectAll': { ja: 'すべてにチェック', en: 'Select All' },
    'gantt.projectSelector.clearAll': { ja: 'すべてのチェックをクリア', en: 'Clear All' },
    'gantt.projectSelector.createProject': { ja: '+ プロジェクトを作成', en: '+ Create Project' },
    ...
    'calendar.offlineTaskAdd': { ja: 'オフラインでタスク追加', en: 'Add Task Offline' },
    'calendar.offlineNote': { ja: 'オフライン時は簡易的なタスク追加のみ可能です', en: 'Limited task addition available while offline' },
    'calendar.projectSelector.title': { ja: '表示するプロジェクトを選択', en: 'Select Projects to Display' },
    'calendar.projectSelector.selectAll': { ja: 'すべてにチェック', en: 'Select All' },
    'calendar.projectSelector.clearAll': { ja: 'すべてのチェックをクリア', en: 'Clear All' },
    ...
    'calendar.actionButtons.addProject': { ja: 'プロジェクトを作成', en: 'Create Project' },
    ...
    'calendar.milestoneTooltip.title': { ja: 'マイルストーン', en: 'Milestone' },
    // プロジェクト詳細
    ...
    'projectDetail.overview': { ja: '概要', en: 'Overview' },
    ...
    'projectDetail.uploadingFiles': { ja: '保存時にアップロードされるファイル', en: 'Files to upload on save' },
    'projectDetail.registeredMaterials': { ja: '登録済み資料', en: 'Registered Materials' },
    'projectDetail.removeAttachment': { ja: '添付を削除', en: 'Remove Attachment' },
    'projectDetail.noRegisteredMaterials': { ja: '登録済みの資料はありません', en: 'No registered materials' },
    'projectDetail.uploadingAttachments': { ja: '添付ファイルをアップロード中...', en: 'Uploading attachments...' },
    ...
    'projectDetail.selectAssignee': { ja: '担当者を選択', en: 'Select Assignee' },
    ...
    'projectDetail.deleteProject': { ja: 'プロジェクトを削除', en: 'Delete Project' },
    'projectDetail.loading': { ja: '読み込み中...', en: 'Loading...' },
    'projectDetail.deleteProjectConfirm': { ja: '本当にこのプロジェクトを削除しますか？', en: 'Are you sure you want to delete this project?' },
    // タスク詳細追加キー
    ...
    'taskDetail.enterUrlOrFileName': { ja: 'URLまたはファイル名', en: 'URL or File Name' },
    'taskDetail.enterUrlOrFileNamePlaceholder': { ja: 'https://... またはファイル名を入力してEnter', en: 'Enter https://... or file name' },
    ...
    'taskDetail.noChildTasks': { ja: '条件に一致する子タスクがありません。', en: 'No child tasks matching the criteria.' },
    'taskDetail.notificationSettings': { ja: '通知設定', en: 'Notification Settings' },
    'taskDetail.taskDeadlineNotification': { ja: 'タスク期限通知', en: 'Task Deadline Notification' },
    'taskDetail.notificationRecipients': { ja: '通知先', en: 'Notification Recipients' },
    'taskDetail.taskOrder': { ja: 'タスクの順番管理', en: 'Task Order Management' },
    'taskDetail.cannotCompleteUntilSubtasksDone': { ja: '子タスク完了まで完了ステータスにできない', en: 'Cannot complete until all subtasks are done' },
    ...
    'projectForm.projectNamePlaceholder': { ja: '例: 新商品開発プロジェクト', en: 'e.g.: New Product Development Project' },
    'projectForm.overview': { ja: '概要', en: 'Overview' },
    'projectForm.overviewPlaceholder': { ja: 'プロジェクトの詳細説明を入力してください', en: 'Enter project details' },
    ...
    'projectForm.loadingMembers': { ja: 'メンバーを読み込み中...', en: 'Loading members...' },
    'projectForm.selectResponsible': { ja: '責任者を選択', en: 'Select Project Owner' },
    'projectForm.noMembers': { ja: 'メンバーが登録されていません', en: 'No members registered' },
    'projectForm.manageMembers': { ja: 'メンバー管理', en: 'Member Management' },
    'projectForm.projectMembers': { ja: 'プロジェクトメンバー', en: 'Project Members' },
    'projectForm.selectMembers': { ja: 'メンバーを選択', en: 'Select Members' },
    'projectForm.tags': { ja: 'タグ', en: 'Tags' },
    'projectForm.tagHelper': { ja: 'Enterで追加 / # は自動で付きます', en: 'Press Enter to add / # is auto-added' },
    'projectForm.noTags': { ja: 'タグはまだ追加されていません', en: 'No tags added yet' },
    'projectForm.milestones': { ja: 'マイルストーン', en: 'Milestones' },
    'projectForm.date': { ja: '日付', en: 'Date' },
    'projectForm.milestoneName': { ja: 'マイルストーン名', en: 'Milestone Name' },
    'projectForm.addMilestone': { ja: 'マイルストーンを追加', en: 'Add Milestone' },
    'projectForm.attachments': { ja: '資料', en: 'Attachments' },
    'projectForm.attachmentHelper': { ja: '1ファイル 5MB 未満・複数添付可', en: 'Max 5MB per file, multiple files allowed' },
    'projectForm.selectFile': { ja: 'ファイルを選択', en: 'Select File' },
    'projectForm.attachmentHint': { ja: 'PDF / 画像 / Office ファイルなど', en: 'PDF / Images / Office files etc.' },
    'projectForm.uploading': { ja: 'アップロード予定', en: 'To Upload' },
    'projectForm.attachmentName': { ja: '資料名（任意）', en: 'Attachment Name (optional)' },
    'projectForm.attachmentUrl': { ja: '資料URL', en: 'Attachment URL' },
    'projectForm.addUrl': { ja: 'URLを追加', en: 'Add URL' },
    'projectForm.registeredAttachments': { ja: '登録済み（URL）', en: 'Registered (URL)' },
    'projectForm.uploadingAttachments': { ja: '添付ファイルをアップロード中...', en: 'Uploading attachments...' },
    'projectForm.themeColor': { ja: 'テーマ色', en: 'Theme Color' },
    'projectForm.themeColorHelper': { ja: 'プロジェクトのカードやタスクに反映されます', en: 'Applies to project cards and tasks' },
    ...
    'taskForm.taskNamePlaceholder': { ja: '例: 要件定義書作成', en: 'e.g.: Create requirements document' },
    'taskForm.tags': { ja: 'タグ', en: 'Tags' },
    'taskForm.tagPlaceholder': { ja: 'タグ名を入力してEnter', en: 'Enter tag name' },
    ...
    'taskForm.selectAssigneePlaceholder': { ja: '担当者を選択してください', en: 'Select an assignee' },
    'taskForm.loadingMembers': { ja: 'メンバーを読み込み中...', en: 'Loading members...' },
    'taskForm.noMembers': { ja: 'メンバーが登録されていません', en: 'No members registered' },
    'taskForm.noMembersDesc': { ja: '先にメンバー管理画面でメンバーを登録してください。', en: 'Please register members in the member management screen first.' },
    'taskForm.startDate': { ja: '開始日', en: 'Start Date' },
    'taskForm.startDatePlaceholder': { ja: '開始日を選択', en: 'Select start date' },
    ...
    'memberManagement.loading': { ja: 'メンバーを読み込み中...', en: 'Loading members...' },
    'memberManagement.noMembers': { ja: 'メンバーがいません', en: 'No members' },
    'memberManagement.addFirstMember': { ja: '最初のメンバーを追加してください', en: 'Add your first member' },
    ...
    'settings.roomInfo.subtitle': { ja: 'このルームの情報を表示します', en: 'Display information for this room' },
